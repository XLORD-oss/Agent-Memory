...
More: [docs/evidence.md](docs/evidence.md) · [docs/architecture.md](docs/architecture.md) · [docs/collaboration.md](docs/collaboration.md) (budget, credits, co-authorship) · [docs/training.md](docs/training.md) (fine-tuning under the contract) · [docs/kaggle.md](docs/kaggle.md) (run the pilot on a free T4 ×2) · [docs/models.md](docs/models.md) (which models, which lane) · [docs/roadmap.md](docs/roadmap.md)
